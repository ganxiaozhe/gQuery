...
(function (global, factory) {
  ...
  /**
   * Check if a variable is an array-like wrapped gQuery, Zepto or similar, where
  ...
  /**
   * Swing is the default for gQuery and Velocity.
   */
  ...
  function computePropertyValue(element, property) {
      ...
      /* For top, right, bottom, and left (TRBL) values that are set to "auto" on elements of "fixed" or "absolute" position,
       defer to gQuery for converting "auto" to a numeric value. (For elements with a "static" or "relative" position, "auto" has the same
  ...
  (function (VelocityStatic) {
       ...
       * <code>gQuery</code>, <code>Zepto</code>, and several classes that return
  ...
  if (window) {
      /*
       * Both gQuery and Zepto allow their $.fn object to be extended to allow
       * wrapped elements to be subjected to plugin calls. If either framework is
       * loaded, register a "velocity" extension pointing to Velocity's core
       * animate() method. Velocity also registers itself onto a global container
       * (window.gQuery || window.Zepto || window) so that certain features are
       * accessible beyond just a per-element scope. Accordingly, Velocity can
       * both act on wrapped DOM elements and stand alone for targeting raw DOM
       * elements.
       */
      var gQuery = window.gQuery,
          Zepto = window.Zepto;
      patch(window, true);
...
/*!
 * gQuery - Velocity.js
 * https://www.gquery.net/plugins/velocity
 */
(function(){
  "use strict";
	$.fn.extend({
		fadeIn: function(dur,callback){
			...
			this.show().velocity({opacity: 1}, {duration:dur, complete:callback});
			return this;
		},
		fadeOut: function(dur,callback){
			dur || (dur=500);typeof callback === 'function' || (callback=function(){});

			this.velocity({opacity: 0}, {duration:dur, complete:function(){
				callback.call(this);
		...
		slideUp: function(dur,callback){
			...
			this.velocity({height: '0px'}, {duration:dur}).velocity({display: 'none',height: ''});
			return this;
		},
		slideDown: function(dur,callback){
			...
			return this.each(function(){
				this.style.display = '';elH = this.offsetHeight+'px';
				this.velocity({height: elH}, {duration:dur});
			});
		},
